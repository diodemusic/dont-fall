...
Expects one sample per line:
    accelX,accelY,accelZ,gyroX,gyroY,gyroZ,angle
with accel in g, gyro in deg/s, angle in degrees.
...
ANGLE_RANGE = 180.0  # degrees, the full range atan2 can return
...
angle_lines = [ax_angle.plot([], [], label="accel angle", color="tab:purple")[0]]
